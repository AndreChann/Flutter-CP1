        ...
        children: [
          ...
          RichText(
            text: const TextSpan(
                ...
                children: [
                  TextSpan(
                      text: '1- Em 1956, um HD de 5 Mb pesava uma tonelada\n'),
                  TextSpan(text: '2- O e-mail foi criado antes da internet\n'),
                  TextSpan(
                      text:
                          '3- A primeira página da internet continua online\n'),
                  TextSpan(
                      text:
                          '4- A primeira foto do mundo levou oito horas para ser capturada\n'),
